...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">Research Staff Homepage</a>
        </div>
    </nav>
</head>
                    ...
                    <div class="col-md-5 border-right">
                        <div class="p-3 py-5">
                            <form action="./editProfile.php" method="post">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6"><label class="labels">Email</label><input type="text" name="email" class="form-control" placeholder="email" disabled value="<?php echo $row['email']; ?>"></div>
...
if (isset($_POST['btn_upProfile'])) {
    ...
    $query = "UPDATE user, userlogin SET user.lname='$lname',user.fname= '$fname', userlogin.pass='$pass', user.phone='$phone', user.street='$street', 
