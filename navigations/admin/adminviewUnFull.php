...
<head>
    ...
    <title>Full Time Undergraduate Student Information</title>
...
<body>
    ...
    <div class="card-body">
        ...
        ?>
        <h3 align="center">Full Time Undergraduate Student Information</h3>
        <div class="table-responsive">
            <table id="usersdata" class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $query = "SELECT * FROM student INNER JOIN undergraduatestudentfulltime ON student.studentid=undergraduatestudentfulltime.studentid 
                    INNER JOIN studentmajor ON undergraduatestudentfulltime.studentid = studentmajor.studentid 
                    INNER JOIN major ON studentmajor.majorid = major.majorid
                    INNER JOIN studentminor ON undergraduatestudentfulltime.studentid = studentminor.studentid 
