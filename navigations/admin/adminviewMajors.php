                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class=" modal-title fs-5" id="editModal">Create A Major</h1>
                        ...
                        <form action="../../php/mm_Code.php" method="post">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="varchar(300)" name="majorname" class="form-control" placeholder="Enter Major Name">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="major_btn" class="btn btn-primary">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
