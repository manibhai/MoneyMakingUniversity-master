                    ...
                    <div class="modal-content">
                        ...
                        <form action="../../php/mm_Code.php" method="post">
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="majorreq_btn" class="btn btn-primary">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<body>
    ...
    <div class="card-body">
        ...
        ?>
        <h3 align="center">Major Requirements</h3>
        <div class="table-responsive">
            <table id="majordata" class="table table-bordered">
                <thead>
                    <tr>
                        <td>Course ID</td>
                        <td>Course Name</td>
                ...
                <tbody>
                    <?php
                    $query = "SELECT * FROM course INNER JOIN department ON course.deptid = department.deptid INNER JOIN major 
                    ON department.deptid = major.deptid INNER JOIN majorcourse ON major.majorid = majorcourse.majorid";
