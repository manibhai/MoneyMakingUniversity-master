  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      <table id="usersdata" class="table table-bordered">
        ...
        <tbody>
          <?php
          $query = "SELECT studenthistory.studentid, studenthistory.semyear, studenthistory.crn, studenthistory.grade FROM studenthistory WHERE studenthistory.studentid= studenthistory.studentid AND studenthistory.studentid=studentid";
