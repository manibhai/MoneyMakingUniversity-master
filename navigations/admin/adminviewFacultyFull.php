...
<head>
    ...
    <title>Full Time Faculty Information</title>
...
<body>
    ...
    <div class="card-body">
        ...
        ?>
        <h3 align="center">Full Time Faculty Information</h3>
        <div class="table-responsive">
            <table id="usersdata" class="table table-bordered">
                ...
                <tbody>
                    <?php
                    $query = "SELECT * FROM facultyfulltime INNER JOIN facultydepartment ON facultyfulltime.facultyid=facultydepartment.facultyid
                                INNER JOIN department ON facultydepartment.deptid=department.deptid 
                                INNER JOIN user ON facultyfulltime.facultyid=user.userid";
