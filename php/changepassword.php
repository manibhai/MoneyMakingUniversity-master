          ...
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <form action="password_reset.php" method="POST">
                ...
                <div class="mb-3">
                  <label>Email</label>
                  <input type="varchar(300)" class="form-control" name="email" value="<?php if (isset($_GET['email'])) {
                                                                                        echo $_GET['email'];
                                                                                      } ?>" placeholder="Enter Your Email" required="">
                </div>
                <div class="mb-3">
                  <label>New Password</label>
                  <input type="varchar(300)" class="form-control" name="newpassword" placeholder="Enter New Password" required="">
                </div>
                <div class="mb-3">
                  <label>Repeat Password</label>
                  <input type="varchar(300)" class="form-control" name="confpassword" placeholder="Enter Confirm Password" required="">
                </div>
