    ...
    ?>
            <form action="code.php" method="POST">
                <div class="form-group">
                    <label>User ID</label>
                    <input type="int" name="userid" value="<?php echo $row['userid'] ?>" class="form-control" placeholder="Enter User's ID">
                </div>
                <div class="form-group">
                ...
                <a href="../navigations/faculty/facultyviewStudent.php" class="btn btn-primary"> Return to Students </a>
            </form>
    <?php
        }
    }
