...
<head>
    ...
    <?php
    if (isset($_POST['editGrade_btn'])) {
        $studentid = $_POST['studentid'];
        $crn = $_POST['crn'];

        $query = "SELECT * FROM studenthistory WHERE studenthistory.studentid = $studentid AND studenthistory.crn = $crn";
    ...
    ?>
            <form action="code.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="hidden" name="userid" value="<?php echo $row['studentid'] ?>" class="form-control" placeholder="Enter Student's ID">
                </div>
                <div class="form-group">
                    <label>CRN</label>
                    <input type="varchar(300)" name="crn" value="<?php echo $row['crn'] ?>" class="form-control" placeholder="Enter CRN">
                </div>
                <div class="form-group">
                    <label>Course</label>
                ...
                <a href="../navigations/admin/adminviewStudentHistory.php" class="btn btn-danger"> Cancel </a>
